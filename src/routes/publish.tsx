...
import { repositoryUrl, submissionUrl } from '../lib/catalog'
...
function Publish() {
  ...
  return <><section className="page-intro"><p className="eyebrow">Built something useful?</p><h1>Submit your plugin.</h1><p>One repository link. We read the manifest, inspect the source, and put the exact commit in the review queue.</p></section>
    <div className="package-columns"><form className="submission-form" onSubmit={event => {
      ...
      <p id="submission-help">Use a public repository with an Omarchy manifest.json. <a href={`${repositoryUrl}/blob/main/PUBLISHING.md#manifestjson`}>See an example manifest ↗</a></p>
      ...
      <p><a href={`${repositoryUrl}/issues?q=is%3Aissue+author%3A%40me`}>Track your submissions on GitHub ↗</a></p>
