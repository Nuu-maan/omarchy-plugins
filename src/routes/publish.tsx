...
export const Route = createFileRoute('/publish')({
  ...
  head: () => ({ meta: [{ title: 'Submit a plugin — Omarchy Plugins' }] }),
  component: Publish,
})
...
function Publish() {
  ...
  return <><section className="page-intro"><p className="eyebrow">Built something useful?</p><h1>Give it a home.</h1><p>One repository link. We read the manifest, inspect the source, and put the exact commit in the review queue.</p></section>
