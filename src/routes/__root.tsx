...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: 'Omachest — Plugins for Omarchy' },
  ...
  component: Root,
  notFoundComponent: () => <section className="page-intro"><p className="eyebrow">404 / not found</p><h1>Nothing at this address.</h1><p>Check the address or browse the catalogue. Revoked plugins remain visible in the directory.</p><Link className="button primary" to="/" search={{ q: '', kind: '', checked: false, sort: 'name' }}>Browse plugins</Link></section>,
  ...
  return <html lang="en" data-theme="matte" suppressHydrationWarning>
    ...
    <body>
      ...
      <header className="site-header"><div className="header-inner">
        <Link to="/" search={{ q: '', kind: '', checked: false, sort: 'name' }} className="brand" aria-label="Omachest home"><Blocks size={23} aria-hidden="true" /><span>omachest<span className="brand-suffix"> / plugins</span></span></Link>
